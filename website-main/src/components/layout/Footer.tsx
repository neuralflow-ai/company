    ...
    <footer className="py-12 glass-card m-4">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          <div className="lg:col-span-2">
            ...
            <p className="max-w-md text-foreground/60 mt-4">
              Leading <strong>AI automation company</strong> and <strong>AI agencies</strong> specializing in <strong>AI bots</strong>, <strong>AI agents</strong>, and <strong>AI automation</strong> services. Transform your operations with proven AI automation solutions.
            </p>
          ...
          <div className="mt-8 md:mt-0">
            <h4 className="font-bold text-white mb-4">AI Automation Services</h4>
        ...
        <div className="border-t border-white/10 pt-6 text-center text-sm text-foreground/50">
          &copy; {new Date().getFullYear()} NeuralFlow - AI Bot, AI Agents & AI Automation Company. All rights reserved.
        </div>
      </div>
    </footer>
  );
