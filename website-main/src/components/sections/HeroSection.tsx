        ...
        <div className="relative z-10 text-center px-4 animate-fade-in parallax-bg" style={{ animationDelay: '0.5s'}}>
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg sm:text-xl text-foreground/90 animate-slide-in-up px-4" style={{ animationDelay: '0.6s' }}>
            <span className="block sm:hidden">
              Transform your business with AI bots and intelligent automation. Trusted by 100k+ businesses worldwide.
            </span>
            <span className="hidden sm:block">
              Transform your business with our AI bots, AI agents, and intelligent automation solutions. Top-rated AI automation company serving 100k+ businesses with cutting-edge AI agencies and automation services.
            </span>
          </p>
